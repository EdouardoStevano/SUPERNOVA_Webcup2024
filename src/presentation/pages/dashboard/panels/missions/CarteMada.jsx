...
function MadaMap2(props) {
  ...
  const afficheo = (e) => {
    ...
    // props.onChildClick(e.target.id);

    var dat = [];
    dat[0] = document.getElementById(e.target.id).classList[2];
    dat[1] = document.getElementById(e.target.id).classList[3];
    dat[2] = document.getElementById(e.target.id).classList[4];
    dat[3] = document.getElementById(e.target.id).classList[1];
    props.datamada(dat);
      ...
      <div>
        ...
        <>
          ...
          <svg
            ...
            xmlSpace="preserve"
            // transform: 'rotateX(43deg)     perspective(700px)            skew(162deg,0deg) scale(3)'
          >
            <style
                type="text/css"
                dangerouslySetInnerHTML={{
                  __html:
                    "\n\t.mada23{fill:#ffffff;stroke:#ffffff;stroke-width:3;stroke-miterlimit:10;transition:0.2s;cursor:pointer} .mada23:hover{fill:#4EC95A;}\n",
                }}
              />
            <path
              id="1"
              className="mada23 Diana 70 20 80"
        ...
        L455.5,210.9z"
            ...
            <path
              id="2"
              className="mada23 Sava 10 80 80"
        ...
        onMouseEnter={afficheo}
            />
            <path
              id="3"
              className="mada23 Androy 30 10 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="4"
              className="mada23 Sofia 30 10 60"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="5"
              className="mada23 Analajirofo 40 40 80"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="6"
              className="mada23 Boeny 70 20 80"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="7"
              className="mada23 Betsiboka 20 50 100"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="8"
              className="mada23 Melaky 70 20 80"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="9"
              className="mada23 Alaotramangoro 90 30 30"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="10"
              className="mada23 Analamanga 50 70 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="11"
              className="mada23 Antsinanana 70 70 20"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="12"
              className="mada23 Bongolava 30 20 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="13"
              className="mada23 Itasy 100 60 40"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="14"
              className="mada23 Vakinakaratra 50 20 100"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="15"
              className="mada23 Menabe 20 40 80"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="16"
              className="mada23 Amoron_i_Mania 60 30 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="17"
              className="mada23 Haute_Matsiatra 50 60 50"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="18"
              className="mada23 Atsimo_Andrefana 10 100 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="19"
              className="mada23 Ihorombe 50 20 40"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="20"
              className="mada23 Anosy 90 20 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="21"
              className="mada23 Atsimo_Atsinanana 50 20 30"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="22"
              className="mada23 Vatovavy 50 70 10"
        ...
        onMouseEnter={afficheo}
            ...
            <path
              id="23"
              className="mada23 Fitovinany 10 10 10"
